(function () {
  ...
  */
  _postAddChecks = function _postAddChecks(timeline, child) {
    ...
    child._start = _round$1((_isNumber$1(position) ? position : position || timeline !== _globalTimeline ? _parsePosition(timeline, position, child) : timeline._time) + child._delay);
  ...
  */
  ...
  Tween.version = Timeline.version = gsap$1.version = "3.7.1";
  _coreReady = 1;
  ...
  */
  ...
  function AllElements(){
      ...
      gsapWithCSS.set(["#Hand1", "#Hand2", "#Hand3", "#Hand4", "#Hand5", "#Hand6", "#Hand7", "#Hand8", "#Hand9", "#Hand10", "#Hand11"], {morphSVG: "#Hand11", ease: "steps (11)"});
